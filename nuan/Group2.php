...
<div class="header">
 ...
 <div class="thergpok" >
     <img src="img/khao1.png" alt=""></a>
 </div>

     <div class="Descritption">
         <p><b>ເປັນອາຫານປະເພດຫນື່ງທີ່ໄດ້ແນວຄິດການເຮັດອາຫານຈາກປະເທດຫວຽດນາມ ຈະເປັນອາຫານທີ່ນໍາໃຊ້ຊີ້ນໄກ່ ແລະ ເປັດເອົາມາປະຍຸກໃຫ້ເກີດເປັນອາຫານຮ້ານເຮົາ ເຊີ່ງໄດ້ມີການແຕ່ງຫນ້າອາຫານກໍ່ຄື ເຮົາຈະລາດຫນ້າເຂົ້າດ້ວຍອາຫານທີ່ເຮົາປຸງແຕ່ງສໍາເລັດ ເຊີ່ງວ່າອາຫານແຕ່ລະຢ່າງມີຄວາມແຕກຕ່າງກັນລວມໄປເຖີງລົດຊາດທີ່ຫອມແຊບກົມກ່ອມ</b></p>
     </div>
...
$sql = "SELECT * FROM products WHERE Ty_ID = 'ເຂົ້າໜ້າ'";
