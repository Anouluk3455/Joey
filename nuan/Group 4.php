...
<div class="header">
 ...
 <div class="thergpok" >
     ...
     <p><b>ເຊີ່ງເປັນອາຫານປະເພດຂະຫນົມປະເພດຫນື່ງທີ່ກີນຫຼັງຮັບປະທານອາຫານແລ້ວ ຫຼື ກີນຫລີ້ນຊີວໆເຊີ່ງເປັນອາຫານປະເພດຫນື່ງເລີຍທີ່ຂາດບໍ່ໄດ້ ເຊີ່ງແຕ່ລະຢ່າງກໍ່ມີຄວາມແຕກຕ່າງກັນອອກໄປ ບໍ່ວ່າຈະເປັນຂະຫນົມລົດຫວານ ຫຼື ລົດເຄັມແຕ່ລະຢ່າງຈະມີລົດຊາດຫອມຫວານ ແຊບລົດຊາດເປັນເອກະລັກຂອງຮ້ານເຮົາ</b></p>
     </div>
...
$sql = "SELECT * FROM products WHERE Ty_ID = 'ຂະໜົມ'";
